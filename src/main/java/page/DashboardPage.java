...
public class DashboardPage extends BasePage{
	...
	@FindBy(how = How.XPATH, using = "//span[contains(text(), 'List Customers')]") WebElement LIST_CUSTOMER_MENU_ELEMENT;
...
//		Assert.assertEquals(DASHBOARD_VALIDATION_ELEMENT.getText(), dashBoardvalText, "Dashboard page is not available!");
		performValidation(DASHBOARD_VALIDATION_ELEMENT.getText(), dashBoardvalText, "Dashboard page is not available!");
	}
